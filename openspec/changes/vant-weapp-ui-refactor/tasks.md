...
- [ ] 5.1 在微信开发者工具中预览所有改造页面，验证弹窗动画、按钮样式、标签显示正常
- [ ] 5.2 执行 E2E 测试回归，检查弹窗交互流程是否正常
- [ ] 5.3 修复 E2E 测试中因弹窗改造导致的选择器或时序问题
...
- [ ] 9.1 在微信开发者工具中预览所有改造页面，验证输入框、Cell、空状态显示正常
- [ ] 9.2 执行 E2E 测试回归
...
- [ ] 13.3 执行完整 E2E 测试回归，验证所有页面功能正常
- [ ] 13.4 在微信开发者工具中检查包体积，确认总大小在合理范围内（预期 < 300KB）
